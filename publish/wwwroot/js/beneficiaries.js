...
function bnfShowDetails(id) {
    ...
    var html =
        ...
        (!b.isActive && String(b.deactivateReason || '').trim() ? '<div class="row mb-3"><div class="col-md-2"><strong>سبب التعطيل:</strong></div><div class="col-md-10">' + esc(String(b.deactivateReason).trim()) + '</div></div>' : '') +
        '</div>' +
