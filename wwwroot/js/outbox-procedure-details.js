...
+ '.opd-table { width:100%; border-collapse:collapse; background:var(--surface-0); border:1px solid var(--gray-200); border-radius:0; font-family:"Cairo",sans-serif; }'
...
+ '.opd-table .opd-th { background:var(--gray-50); color:var(--gray-700); font-weight:700; font-size:13px; padding:12px 14px; text-align:right; border:1px solid var(--gray-200); white-space:nowrap; width:1%; }'
+ '.opd-table .opd-td { padding:12px 14px; font-size:13px; color:var(--gray-900); border:1px solid var(--gray-200); vertical-align:middle; background:var(--surface-0); }'
...
+ '.opd-table-scroll { overflow-x:auto; border:1px solid var(--gray-200); border-top:none; border-bottom-right-radius:10px; border-bottom-left-radius:10px; background:var(--surface-0); }'
+ '.opd-wf-table thead th { background:var(--gray-50); color:var(--gray-700); font-weight:700; font-size:13px; padding:12px 14px; text-align:center; border:1px solid var(--gray-200); white-space:nowrap; }'
+ '.opd-wf-table tbody td { padding:12px 14px; font-size:13px; color:var(--gray-800); border:1px solid var(--gray-200); text-align:center; vertical-align:middle; }'
...
+ '.opd-empty-row { text-align:center; color:var(--gray-400); font-style:normal; padding:18px 8px; font-size:13px; background:var(--surface-0); }'
...
+ '.opd-pill-urgent{ background:#fef3f2; color:#b42318; border-color:#fecdca; }'
+ '.opd-pill-high  { background:var(--surface-0)6ed; color:#b54708; border-color:#fed7aa; }'
+ '.opd-pill-med   { background:#fef9c3; color:#854d0e; border-color:#fde047; }'
+ '.opd-pill-low   { background:#f0f9ff; color:#075985; border-color:#bae6fd; }'
